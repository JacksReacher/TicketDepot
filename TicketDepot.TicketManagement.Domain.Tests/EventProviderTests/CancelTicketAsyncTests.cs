...
namespace TicketDepot.TicketManagement.Domain.Tests
{
    public partial class EventProviderTests
    {
        ...
        [DataRow("")]
        [DataRow(null)]
        public async Task When_ReservationId_Null_Then_Exception(string reservationId)
        {
        ...
        [DataRow("")]
        [DataRow(null)]
        public async Task When_TransactionId_Null_Then_Exception(string transactionId)
        {
        ...
        [TestMethod]
        public async Task When_Validator_Returns_Null_Reservation()
        {
        ...
        [TestMethod]
        public async Task When_Reserveation_Reserved_Then_PreconditionFailed()
        {
            Reservation reservation = DomainFactory.GetReservation();
